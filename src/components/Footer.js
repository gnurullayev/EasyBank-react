...
function Footer() {
    return (
        <footer class="footer">
        <div class="fooyter__container container">
            <div class="footer__inner">
                <ul class="footer__list">
                    <li class="footer__item">
                        <img class="footer__logo" src= {logo} alt="Logo" width="139" height="20" />

                        <ul class="footer__social-networks">
                            <li class="footer__social-network">
                                <a class="footer__network-link footer__social-network--facebook" href="#">
                                    <svg class="social-network" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="footer__social-network">
                                <a class="footer__network-link footer__social-network--facebook" href="#">
                                    <svg class="social-network" width="21" height="18" viewBox="0 0 21 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li class="footer__item">
                        <ul class="footer__nav-list">
                            ...
                            <li class="footer__nav-item">
                                <a class="footer__nav-link" href="#" >Support</a>
                            </li>
                    ...
                    <li class="footer__item">
                        <button class="footer__invite-button invite-button" type="button">
                            <a class="invite-button__link" href="#">Request Invite</a>
                        </button>
                        <p class="footer__note">© Easybank. All Rights Reserved</p>
                    </li> 
                </ul>
            </div>
        </div>
